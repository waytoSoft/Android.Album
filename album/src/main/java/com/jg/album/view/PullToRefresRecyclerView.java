...
import com.jg.album.R;
import com.jg.album.SpaceItemDecoration;
...
public class PullToRefresRecyclerView extends LinearLayout implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public void initView() {
        ...
        mSwipeRefreshLayout = rootView.findViewById(R.id.pullToRefresh_swiperefreshLayout);
        mRecyclerView = rootView.findViewById(R.id.pullToRefresh_recycleListview);
        mEmptyTextView = rootView.findViewById(R.id.pullToRefresh_Empty_TextView);
